...
class HealingMNIST():
    def __init__(self, seq_len=5, square_count=3, square_size=5, noise_ratio=0.15, digits=range(10), test=False):
        ...
        for img in mnist_train:
            train_img, train_tar, train_rot = heal_image(img, seq_len, square_count, square_size, noise_ratio)
        ...
        for img in mnist_test:
            test_img, test_tar, test_rot = heal_image(img, seq_len, square_count, square_size, noise_ratio)
