...
print("Reading data")
train_x, train_y = readfile("/team_stor1/zhuqinghui/K/food-11/training", True)
print("Size of training data = {}".format(len(train_x)))
val_x, val_y = readfile("/team_stor1/zhuqinghui/K/food-11/validation", True)
print("Size of validation data = {}".format(len(val_x)))
test_x = readfile("/team_stor1/zhuqinghui/K/food-11/testing", False)
