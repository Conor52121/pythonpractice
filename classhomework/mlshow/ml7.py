...
class initface():
    def __init__(self, master):
        ...
        self.initface.pack()
        label1 = tk.Label(self.initface, text='机器学习期末大作业', font=('Arial', 16)).grid()
        label2 = tk.Label(self.initface, text='姓名:王盛康', font=('Arial', 14)).grid()
        label3 = tk.Label(self.initface, text='班级:电子与通信工程', font=('Arial', 14)).grid()
        label4 = tk.Label(self.initface, text='学号:201932071', font=('Arial', 14)).grid()
        btn = tk.Button(self.initface, text='下一页', command=self.change).grid()
