...
X_train_set=Dataset(X_train)
X_test_set=Dataset(X_test)
X_train_loader=DataLoader(X_train,batch_size=128,shuffle=False)
...
for epoch in range(epochs):
    for i,X_train in enumerate(X_train_loader):
        pre = model(X_train)
